...
export const ServiceIcon = ({ size = 20, color = "currentColor" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M19.07 4.93l-2.12 2.12m-9.9 9.9l-2.12 2.12M4.93 19.07l2.12-2.12m9.9-9.9l2.12-2.12"></path>
  </svg>
);
...
export const MaximizeIcon = ({ size = 24, color = "white" }) => (
...
export const MinimizeIcon = ({ size = 24, color = "white" }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none">
