...
//   // ✅ ChatGPT-style streaming text effect
...
//     if (stage === "askName") {
//       const nameInput = currentInput.trim();

//       if (
//         invalidNames.includes(nameInput.toLowerCase()) ||
...
//     if (stage === "askPhone") {
//       const phoneInput = currentInput.trim();
...
//         // ✅ Use streaming effect for API response
...
//       // ✅ Use streaming effect for option answers
//       botReply(
//         {
//           sender: "bot",
//           text: fullAnswer,
...
//                       >
//                         {Icon && <Icon size={16} className="option-icon" />}
//                         {opt.label}
//                       </button>
//                     );
//                   })}
...
//           Powered by{" "}
//           <a href="https://troudz.com/" target="_blank">
//             TROUDZ AI LABS
//           </a>
//         </div>
//       </div>
